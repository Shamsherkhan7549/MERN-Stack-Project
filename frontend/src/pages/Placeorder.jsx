  ...
  const initPay = (order) => {
    const options = {
      ...
      handler: async (response) => {
        ...
        try {
          const {data} = axios.post(backendUrl,+'/order/verifyRazorpay',response,{headers:{token}} )
          if(data.success){
            setCartItems({})
            navigate('/orders');
          }
        ...
        <div className='flex flex-col gap-5 md:flex-3 flex-4'>
          <div className='flex sm:flex-row flex-col sm:gap-3 gap-5'>
            <input
              ...
              className=' border-1 border-gray-300 pl-3 py-1 border rounded w-full'
              required
            />
            <input
              type='text'
          ...
          <input
            ...
            className=' border-1 border-gray-300 pl-3 py-1 border rounded'
            required
          />
        </div>
          ...
          <div className='flex flex-col gap-5 items-start'>
            ...
            <div className='flex justify-around w-full'>
              <div
                ...
                className='flex items-center gap-10 border border-gray-200 px-3 py-2'>
              ...
              <div
                ...
                className='flex items-center gap-6 border border-gray-200 px-3 py-2'>
                <p className='border border-gray-200  w-5 h-5 rounded-full active:bg-green-400 cursor-pointer'></p>
            ...
            <div className='text-end w-full mt-3  '>
              <button
                type='submit'
                className='bg-black text-white text-md px-10 py-2'>
                PLACE ORDER
              </button>
            </div>
          </div>
